$(document).ready( function() { 
	...
	var DMWSRadarChart = {
	  draw: function(id, prevprogdataa, tthisprogdataa, options, showprevdata){
		  var cfg = {
			 radius: 5,
			 w: 600,
			 h: 600,
			...
			cfg.maxValue = Math.max(cfg.maxValue, d3.max(prevprogdataa, function(i){return d3.max(i.map(function(o){return o.value;}))}));
			var allAxis = (prevprogdataa[0].map(function(i, j){return i.axis}));
	...
	/*$('.progdatabutton').each(function () {
		var thisid = $(this).attr('id');
		progdatabuttonida.push(thisid);
		toggledprogbuttonsa[thisid] = "hide";
	});*/
	/*function progdatabuttontogglebar() {
		var ogbtncolour = $(this).css('color');
		if ($(this).css('border-bottom-width') == "5px"){
			$(this).css('border-bottom-width',"1px");
			$(this).css('border-bottom-color',ogbtncolour);
		}
		else {
			$(this).css('border-bottom-width',"5px");
			var polycolour = $('.radar-chart-serie'+counter).css('color');
			$(this).css('border-bottom-color',polycolur);
			}
	...
	/*alert(GLOBALS['dmwssu_marriagestatus']);
	var colorscale = d3.scale.category10();
	var checker = $(GLOBALS['dmwssux_fname']).val();
	alert(checker);
	if (GLOBALS['dmwssu_marriagestatus'] != "") {
	//var marriagestatus = GLOBALS['dmwssu_marriagestatus'];
	
	 $("#".marriagestatus).prop("checked", true); 
	}*/
	...
	function loadprogressarray() {		
		...
		DMWSRadarChart.draw("#chart", prevprogdataa, thisprogdataa, myradarchartcfg);
		...
		$('.progdatabutton').each(function() {
			...
			if ($(this).css('opacity') == "1") {
				...
				/*$('#'+progdatabuttonida[counter]).on('click', function(event) {
					var polycolour = $('.radar-chart-serie'+counter).css('fill');
				...
				if (counter == 0){
					$(this).on('click', function(event) {
						var polycolour = $('.radar-chart-serie0').css('fill');
						$('.radar-chart-serie0').toggle();
						var ogbtncolour = $(this).css('color');
						if ($(this).css('border-bottom-width') == "1px"){
						$(this).css('border-bottom-width',"5px");
						$(this).css('border-bottom-color',polycolour);
				...
				if (counter == 1){
					$(this).on('click', function(event) {
						var polycolour = $('.radar-chart-serie1').css('fill');
						$('.radar-chart-serie1').toggle();
						var ogbtncolour = $(this).css('color');
				...
				if (counter == 2){
					$(this).on('click', function(event) {
						var polycolour = $('.radar-chart-serie2').css('fill');
						$('.radar-chart-serie2').toggle();
						var ogbtncolour = $(this).css('color');
						if ($(this).css('border-bottom-width') == "1px"){
						$(this).css('border-bottom-width',"5px");
						$(this).css('border-bottom-color',polycolour);
				...
				if (counter == 3){
					$(this).on('click', function(event) {
						var polycolour = $('.radar-chart-serie3').css('fill');
						$('.radar-chart-serie3').toggle();
						var ogbtncolour = $(this).css('color');
						if ($(this).css('border-bottom-width') == "1px"){
						$(this).css('border-bottom-width',"5px");
						$(this).css('border-bottom-color',polycolour);
				...
				if (counter == 4){
					$(this).on('click', function(event) {
						var polycolour = $('.radar-chart-serie4').css('fill');
						$('.radar-chart-serie4').toggle();
						var ogbtncolour = $(this).css('color');
						if ($(this).css('border-bottom-width') == "1px"){
						$(this).css('border-bottom-width',"5px");
						$(this).css('border-bottom-color',polycolour);
				...
				//alert('radar-chart-serie'+counter);
				counter++;
			}
