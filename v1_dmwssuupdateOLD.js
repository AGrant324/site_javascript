...
function initialformatter() {
	...
	$('#losexpectedcalc').val(days_between(DDsMMsYYYYtoYYYY_MM_DD(fromdatetext),DDsMMsYYYYtoYYYY_MM_DD(todatetext)));
	var todatetext = $('#dmwssu_dischargedate').val();
	var fromdatetext = $('#dmwssu_dmwsadmissiondate').val();
	$('#losactualcalc').val(days_between(DDsMMsYYYYtoYYYY_MM_DD(fromdatetext),DDsMMsYYYYtoYYYY_MM_DD(todatetext)));			
