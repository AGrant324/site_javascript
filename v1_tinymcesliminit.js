tinymce.init({
  ...
  */  
  plugins: [
    ...
    'emoticons template paste textcolor colorpicker textpattern' // suppress float toolbar  
  ],
  // following line is to preserve bootstrap formatted sections
  // extended_valid_elements : "*[*]",
  extended_valid_elements : "ol[class],ul[class],li[class|data-target|data-slide-to|a|i],a[class|href|data-slide|span],span[*],i[class],div[*],form[*],p[*],br[*],hr[*],section[*],script[*]",
  ...
  toolbar2: 'print preview media | forecolor backcolor | emoticons | pluginarea | code',
  image_advtab: true,
  templates: [
