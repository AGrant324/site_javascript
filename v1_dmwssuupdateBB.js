$(document).ready( function() { 
	...
	if ( dmwsvisit_type == "undefined" ) { dmwsvisit_type = "Subsequent"; }   // CHECK 
	...
	mandfieldsremainingnamesa['dmwsreferrerupdate_personid'] = "Referrer Update WO";
	...
	*/
	...
	$('#dmwsreferrerupdate_add_new').on('click', function(event) {
		...
		insertrefin = insertrefin + '<div class="col-sm-1"><input id="dmwsreferrerupdate_date_'+newref+'" name="dmwsreferrerupdate_date_'+newref+'_dd/mm/yyyy" class="mand mandcheck datepicker form-control" style="background-color: pink; color: black; text-align: left;" value=""></div>';
		insertrefin = insertrefin + '<div class="col-sm-2"><input id="dmwsreferrerupdate_personid_'+newref+'" name="dmwsreferrerupdate_personid_'+newref+'" class="mand mandcheck form-control" style="background-color: pink; color: black; text-align: left;" type="text" value=""></div>';
...
function dmwsreferrerupdatedeletelistener() {
	$('.dmwsreferrerupdatedelete').on('click', function(event) {			
		...
		if (result) {
			...
			var removingid3 = 'dmwsreferrerupdate_personid_'+idsplit[2];
