$(document).ready( function() { 
    ...
    sfmgroundvisit_sfmgroundid = $('#sfmgroundvisit_sfmgroundid').val();
    sfmgroundvisit_id = $('#sfmgroundvisit_id').val();	
	...
	function SaveAction() {	
		...
		$("#sfmgroundvisitupdateform").submit();
	}
	...
	$('#mpdfreports').on('click', function(event) {
		alert(sfmgroundvisit_sfmgroundid + "," + sfmgroundvisit_id);
		var sUrl = JSSitePHPURL()+"/"+JSCodeVersion()+"_mpdfrelevantreportlist.php"+STDPARMS();
		sUrl = sUrl + "&keynamelist=sfmgroundvisit_sfmgroundid,sfmgroundvisit_id"+ "&keyvaluelist=" + sfmgroundvisit_sfmgroundid + "," + sfmgroundvisit_id;
