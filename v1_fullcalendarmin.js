...
! function(t, e) {
	...
	return function(t) {
		...
		var o = n(2),
					...
					for (r = 0; r < h; r++) {
						if (i = p[r], o = 0, a = s("<tr/>"), g.push([]), v.push([]), y.push([]), i)
							for (l = 0; l < i.length; l++) {
								for (u = i[l], n(u.leftCol), d = s('<td id="'+e[0]['footprint']['eventDef']['id']+'" class="fc-event-container"/>').append(u.el), u.leftCol !== u.rightCol ? d.attr("colspan", u.rightCol - u.leftCol + 1) : y[r][o] = d; o <= u.rightCol;) v[r][o] = d, g[r][o] = u, o++;
								a.append(d)
							}
			...
			var elem = document.getElementById('T20190703094703');
			console.log(elem);
		e.default = u
	}, function(t, e, n) {
		Object.defineProperty(e, "__esModule", {
